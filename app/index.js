...
var RNRAngularGenerator = yeoman.generators.Base.extend({
  init: function () {
  ...
  appJs: function() {
    ...
    file = file.replace("//= require jquery\n", '')
               ...
               .replace("//= require_tree .", '//= require config.js\n//=require_tree ./modules\n//= require main');

    this.write(path, file);
    this.template('app/main.coffee', 'app/assets/javascripts/main.coffee');
    this.template('app/config.js.coffee', 'app/assets/javascripts/config.js.coffee');
	},
...
module.exports = RNRAngularGenerator;
